...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>mybrandbucket</title>
        <meta property="og:title" content="mybrandbucket" />
      </Helmet>
      <header data-thq="thq-navbar" className="home-navbar-interactive">
        <img alt="logo" src="/logo-1500w.png" className="home-logo" />
        <div
      ...
      <img alt="image" src="/landing-1500w.jpg" className="home-image1" />
    </div>
  )
}
